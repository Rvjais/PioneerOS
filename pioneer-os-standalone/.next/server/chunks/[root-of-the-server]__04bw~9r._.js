;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="a73a037d-0788-17fd-5e3b-a60379c808d7")}catch(e){}}();
...
${n}`,html:`
    ...
    `})}e.s(["sendAdminMagicLinkEmail",0,p,"sendInvoiceEmail",0,m,"sendMagicLinkEmail",0,d,"sendOnboardingEmail",0,u,"sendPaymentReceivedEmail",0,y],120674)},540699,e=>{"use strict";var t=e.i(747909),r=e.i(174017),n=e.i(996250),a=e.i(759756),i=e.i(561916),s=e.i(174677),o=e.i(869741),l=e.i(316795),c=e.i(487718),d=e.i(995169),p=e.i(47587),u=e.i(666012),m=e.i(570101),y=e.i(626937),g=e.i(10372),f=e.i(193695);e.i(820232);var h=e.i(600220),x=e.i(89171),b=e.i(35344),v=e.i(120674),A=e.i(255627),E=e.i(456622),k=e.i(254799);let I=process.env.NEXTAUTH_URL||"https://brandingpioneers.in";async function R(e){var t,r;try{let n=e.headers.get("x-forwarded-for")?.split(",")[0]||e.headers.get("x-real-ip")||"unknown",a=await (0,E.checkRateLimit)(`magic-link:${n}`,{maxRequests:5,windowMs:9e5});if(!a.success)return x.NextResponse.json({error:"Too many login attempts. Please try again later."},{status:429,headers:{"Retry-After":String(a.retryAfter||900)}});let{identifier:i,channel:s="EMAIL"}=await e.json();if(!i)return x.NextResponse.json({error:"Email, phone, or Employee ID is required"},{status:400});let o=[i],l=i.replace(/\D/g,"");10===l.length?o.push(`+91${l}`,`91${l}`):12===l.length&&l.startsWith("91")?o.push(`+${l}`,l.slice(2)):13===l.length&&l.startsWith("91")&&o.push(l,`+${l}`,l.slice(2));let[c]=await Promise.all([b.prisma.user.findFirst({where:{deletedAt:null,OR:[{email:i},{phone:{in:o}},{empId:i.toUpperCase()}],status:{in:["ACTIVE","PROBATION"]}}}),b.prisma.magicLinkToken.deleteMany({where:{user:{OR:[{email:i},{phone:{in:o}},{empId:i.toUpperCase()}]},usedAt:null}})]);if(!c)return x.NextResponse.json({success:!0,message:"If an account exists, a login link has been sent."});let d=s;if("EMAIL"===s&&!c.email)if(!c.phone)return x.NextResponse.json({error:"No email or phone on file. Please contact HR."},{status:400});else d="WHATSAPP";b.prisma.magicLinkToken.deleteMany({where:{OR:[{expiresAt:{lt:new Date}},{usedAt:{not:null},createdAt:{lt:new Date(Date.now()-864e5)}}]}}).catch(()=>{});let p=k.default.randomBytes(32).toString("hex"),u=k.default.createHash("sha256").update(p).digest("hex"),m=new Date(Date.now()+18e5);if(await b.prisma.magicLinkToken.create({data:{token:u,userId:c.id,channel:d,expiresAt:m}}),"EMAIL"===d&&c.email){let e=await (0,v.sendMagicLinkEmail)({to:c.email,token:p,firstName:c.firstName});if(!e.success)return console.error("Failed to send magic link email:",e.error),x.NextResponse.json({error:"Failed to send login link. Please try again."},{status:500})}else if("WHATSAPP"===d){let e,r=await (0,A.sendWhatsAppMessage)({phone:c.phone,message:(t=c.firstName,e=`${I}/auth/magic?token=${p}`,`🔐 *Pioneer OS Login*
...
If you didn't request this, please ignore this message.`)});if(1!==r.status)return console.error("Failed to send WhatsApp magic link:",r.message),x.NextResponse.json({error:r.message||"Failed to send WhatsApp link. Please try email."},{status:500})}return x.NextResponse.json({success:!0,message:"EMAIL"===d?`Login link sent to ${function(e){let[t,r]=e.split("@"),n=t.substring(0,2)+"***";return`${n}@${r}`}(c.email)}`:`Login link sent to ${(r=c.phone).substring(0,2)+"****"+r.substring(r.length-4)}`,channel:d})}catch(t){let e;return console.error("Magic link error:",t),(e=t instanceof Error?t.message:String(t)).includes("permission denied for schema public")?x.NextResponse.json({error:"Magic link is blocked because the database user cannot access schema public. Grant Postgres schema permissions to the app user and retry."},{status:503}):e.includes("Authentication failed against database server")?x.NextResponse.json({error:"Magic link is blocked because the database credentials are invalid. Update DATABASE_URL and retry."},{status:503}):e.includes("Can't reach database server")?x.NextResponse.json({error:"Magic link is blocked because the database server is unreachable. Check DATABASE_URL and database availability."},{status:503}):x.NextResponse.json({error:"Something went wrong. Please try again."},{status:500})}}e.s(["POST",0,R],600739);var w=e.i(600739);let S=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/auth/magic-link/route",pathname:"/api/auth/magic-link",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/auth/magic-link/route.ts",nextConfigOutput:"standalone",userland:w}),{workAsyncStorage:T,workUnitAsyncStorage:P,serverHooks:_}=S;async function C(e,t,n){n.requestMeta&&(0,a.setRequestMeta)(e,n.requestMeta),S.isDev&&(0,a.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let x="/api/auth/magic-link/route";x=x.replace(/\/index$/,"")||"/";let b=await S.prepare(e,t,{srcPage:x,multiZoneDraftMode:!1});if(!b)return t.statusCode=400,t.end("Bad Request"),null==n.waitUntil||n.waitUntil.call(n,Promise.resolve()),null;let{buildId:v,params:A,nextConfig:E,parsedUrl:k,isDraftMode:I,prerenderManifest:R,routerServerContext:w,isOnDemandRevalidate:T,revalidateOnlyGenerated:P,resolvedPathname:_,clientReferenceManifest:C,serverActionsManifest:N}=b,D=(0,o.normalizeAppPath)(x),O=!!(R.dynamicRoutes[D]||R.routes[_]),L=async()=>((null==w?void 0:w.render404)?await w.render404(e,t,k,!1):t.end("This page could not be found"),null);if(O&&!I){let e=!!R.routes[_],t=R.dynamicRoutes[D];if(t&&!1===t.fallback&&!e){if(E.adapterPath)return await L();throw new f.NoFallbackError}}let $=null;!O||S.isDev||I||($="/index"===($=_)?"/":$);let K=!0===S.isDev||!O,B=O&&!K;N&&C&&(0,s.setManifestsSingleton)({page:x,clientReferenceManifest:C,serverActionsManifest:N});let F=e.method||"GET",q=(0,i.getTracer)(),M=q.getActiveScopeSpan(),U=!!(null==w?void 0:w.isWrappedByNextServer),z=!!(0,a.getRequestMeta)(e,"minimalMode"),Y=(0,a.getRequestMeta)(e,"incrementalCache")||await S.getIncrementalCache(e,E,R,z);null==Y||Y.resetRequestCache(),globalThis.__incrementalCache=Y;let j={params:A,previewProps:R.preview,renderOpts:{experimental:{authInterrupts:!!E.experimental.authInterrupts},cacheComponents:!!E.cacheComponents,supportsDynamicResponse:K,incrementalCache:Y,cacheLifeProfiles:E.cacheLife,waitUntil:n.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,n,a)=>S.onRequestError(e,t,n,a,w)},sharedContext:{buildId:v}},W=new l.NodeNextRequest(e),H=new l.NodeNextResponse(t),G=c.NextRequestAdapter.fromNodeNextRequest(W,(0,c.signalFromNodeResponse)(t));try{let a,s=async e=>S.handle(G,j).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=q.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==d.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let n=r.get("next.route");if(n){let t=`${F} ${n}`;e.setAttributes({"next.route":n,"http.route":n,"next.span_name":t}),e.updateName(t),a&&a!==e&&(a.setAttribute("http.route",n),a.updateName(t))}else e.updateName(`${F} ${x}`)}),o=async a=>{var i,o;let l=async({previousCacheEntry:r})=>{try{if(!z&&T&&P&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let i=await s(a);e.fetchMetrics=j.renderOpts.fetchMetrics;let o=j.renderOpts.pendingWaitUntil;o&&n.waitUntil&&(n.waitUntil(o),o=void 0);let l=j.renderOpts.collectedTags;if(!O)return await (0,u.sendResponse)(W,H,i,j.renderOpts.pendingWaitUntil),null;{let e=await i.blob(),t=(0,m.toNodeOutgoingHttpHeaders)(i.headers);l&&(t[g.NEXT_CACHE_TAGS_HEADER]=l),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==j.renderOpts.collectedRevalidate&&!(j.renderOpts.collectedRevalidate>=g.INFINITE_CACHE)&&j.renderOpts.collectedRevalidate,n=void 0===j.renderOpts.collectedExpire||j.renderOpts.collectedExpire>=g.INFINITE_CACHE?void 0:j.renderOpts.collectedExpire;return{value:{kind:h.CachedRouteKind.APP_ROUTE,status:i.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:n}}}}catch(t){throw(null==r?void 0:r.isStale)&&await S.onRequestError(e,t,{routerKind:"App Router",routePath:x,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:B,isOnDemandRevalidate:T})},!1,w),t}},c=await S.handleResponse({req:e,nextConfig:E,cacheKey:$,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:R,isRoutePPREnabled:!1,isOnDemandRevalidate:T,revalidateOnlyGenerated:P,responseGenerator:l,waitUntil:n.waitUntil,isMinimalMode:z});if(!O)return null;if((null==c||null==(i=c.value)?void 0:i.kind)!==h.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==c||null==(o=c.value)?void 0:o.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});z||t.setHeader("x-nextjs-cache",T?"REVALIDATED":c.isMiss?"MISS":c.isStale?"STALE":"HIT"),I&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let d=(0,m.fromNodeOutgoingHttpHeaders)(c.value.headers);return z&&O||d.delete(g.NEXT_CACHE_TAGS_HEADER),!c.cacheControl||t.getHeader("Cache-Control")||d.get("Cache-Control")||d.set("Cache-Control",(0,y.getCacheControlHeader)(c.cacheControl)),await (0,u.sendResponse)(W,H,new Response(c.value.body,{headers:d,status:c.value.status||200})),null};U&&M?await o(M):(a=q.getActiveScopeSpan(),await q.withPropagatedContext(e.headers,()=>q.trace(d.BaseServerSpan.handleRequest,{spanName:`${F} ${x}`,kind:i.SpanKind.SERVER,attributes:{"http.method":F,"http.target":e.url}},o),void 0,!U))}catch(t){if(t instanceof f.NoFallbackError||await S.onRequestError(e,t,{routerKind:"App Router",routePath:D,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:B,isOnDemandRevalidate:T})},!1,w),O)throw t;return await (0,u.sendResponse)(W,H,new Response(null,{status:500})),null}}e.s(["handler",0,C,"patchFetch",0,function(){return(0,n.patchFetch)({workAsyncStorage:T,workUnitAsyncStorage:P})},"routeModule",0,S,"serverHooks",0,_,"workAsyncStorage",0,T,"workUnitAsyncStorage",0,P],540699)}];

//# debugId=a73a037d-0788-17fd-5e3b-a60379c808d7
//# sourceMappingURL=%5Broot-of-the-server%5D__04bw~9r._.js.map